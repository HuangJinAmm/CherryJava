package com.cherryjava.common.utils.file;
...
public class FileUploadUtils {
    ...
    public static String getFileAbsolutePath(String subDir, String fileName) {
        return ProjectConfig.getFileBaseDir() + File.separator + subDir + File.separator + fileName;
    }
