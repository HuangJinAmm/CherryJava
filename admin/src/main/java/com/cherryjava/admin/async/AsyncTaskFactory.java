package com.cherryjava.admin.async;
...
import com.cherryjava.common.utils.ip.IpRegionUtil;
...
public class AsyncTaskFactory {
    ...
    public static final Logger log = LoggerFactory.getLogger(AsyncTaskFactory.class);
