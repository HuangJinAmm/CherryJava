...
public class SecurityConfig {
    ...
    public SecurityConfig(TokenService tokenService, RedisCacheService redisCache, JwtAuthenticationTokenFilter jwtTokenFilter, UserDetailsService userDetailsService, CorsFilter corsFilter) {
