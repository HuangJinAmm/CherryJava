...
public class GlobalExceptionInterceptor {
    private final static Logger log = LoggerFactory.getLogger(GlobalExceptionInterceptor.class);
    ...
    public ResponseDTO<?> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException e,
        ...
        return ResponseDTO.fail(new ApiException(ErrorCode.Client.COMMON_REQUEST_METHOD_INVALID, e.getMethod()));
    }
