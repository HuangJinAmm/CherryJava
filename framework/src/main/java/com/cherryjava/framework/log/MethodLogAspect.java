package com.cherryjava.framework.log;
...
public class MethodLogAspect {
    ...
    private final static Logger log = LoggerFactory.getLogger(MethodLogAspect.class);

    @Pointcut("execution(public * com.cherryjava..db.*Service.*(..))")
