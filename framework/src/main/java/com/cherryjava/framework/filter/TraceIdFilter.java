package com.cherryjava.framework.filter;
...
public class TraceIdFilter implements Filter {
    ...
    private final static Logger log = LoggerFactory.getLogger(TraceIdFilter.class);

    private String requestIdKey;

    public TraceIdFilter(String requestIdKey) {
