package com.cherryjava.framework.mybatisplus;
...
public class CodeGenerator {
    ...
    static class CodeBuilder {
        ...
        public CodeBuilder author(String author) {
            gen.author = author;
            return this;
        }
        ...
        public CodeBuilder databaseUrl(String databaseUrl) {
            gen.databaseUrl = databaseUrl;
            return this;
        }

        public CodeBuilder username(String username) {
            gen.username = username;
            return this;
        }

        public CodeBuilder password(String password) {
            gen.password = password;
            return this;
        }

        public CodeBuilder parentPackage(String parentPackage) {
            gen.parentPackage = parentPackage;
            return this;
        }

        public CodeBuilder isExtendsFromBaseEntity(boolean isExtendsFromBaseEntity) {
            gen.isExtendsFromBaseEntity = isExtendsFromBaseEntity;
            return this;
        }
...
//        JSON ymlJson = JSONUtil.parse(new Yaml().load(ResourceUtil.getStream("application-dev.yml")));
    ...
    public void generateCode() {
        FastAutoGenerator generator = FastAutoGenerator.create(
                new DataSourceConfig.Builder(databaseUrl, username, password)
//            .schema("mybatis-plus")
